...
% ---------- Format judul bab: Calibri 16, sub judul 10 ----------
\usepackage{titlesec}
\titleformat{\chapter}[display]
  {\centering\bfseries}
  {\fontsize{16}{19}\selectfont BAB \thechapter}
  {4pt}
...
% Ukuran font mengikuti spesifikasi template:
% judul 16, sub judul 10 (Tabel 1.1 butir 7).
% ============================================================
\thispagestyle{empty}
{\centering
  \vspace*{3cm}
  {\fontsize{16}{19}\selectfont\bfseries \judulbuku\par}
  \vspace{0.5em}
  {\fontsize{10}{12}\selectfont \subjudulbuku\par}
  \vspace{3cm}
  {\fontsize{11}{13}\selectfont\bfseries Rolly Maulana Awangga\par}
  \vspace{0.3em}
  {\fontsize{11}{13}\selectfont\bfseries Idam Fadilah\par}
  \vfill
  \begin{tabular}{@{}c@{\hspace{1.5em}}l@{}}
    \raisebox{-0.4\height}{\includegraphics[width=3.5cm]{images/image6.png}} &
    \begin{tabular}[c]{@{}l@{}}
      \textbf{PT. Penerbit Buku Pedia}\\[2pt]
      \textbf{2023}
    \end{tabular}
  \end{tabular}\par
}
...
% di bagian bawah dengan font Book Antiqua ukuran 8.
% ============================================================
\thispagestyle{empty}
...
{\fontfamily{pplx}\fontsize{8}{10}\selectfont % pplx = Palatino, pengganti Book Antiqua
...
\medskip
\noindent Hak cipta dilindungi undang-undang\\
...
Membuat prakata menggunakan font Calibri, ukuran 11 dengan spasi 1. Di
  ...
  \begin{tabularx}{\textwidth}{@{}c l X l@{}}
    ...
    7. & Halaman redaksi   & Informasi Redaksi Penerbitan setelah
       ...
       &                   & Judul yang melekat pada bagian atas dengan
         font Calibri 16 untuk judul dan 10 untuk sub judul & 16 dan 10 \\
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{|X|}
    \hline
    \textbf{CATATAN PENTING YANG PERLU DICERMATI}\newline
    \textbf{PENYUSUNAN BUKU REFERENSI} \\
    \hline
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{|X|}
    \hline
    \textbf{CATATAN PENTING YANG PERLU DICERMATI}\newline
    \textbf{PENYUSUNAN BUKU MONOGRAPH} \\
    \hline
    \begin{enumerate}[leftmargin=*, nosep, before=\vspace{2pt}, after=\vspace{2pt}]
      \item Merupakan hasil penelitian
...
\verb|\cite{kunci}|, misalnya sitasi buku \cite{ali2017milenial},
artikel jurnal \cite{aziri2011job, bencsik2016generations,
berkup2014working}, maupun contoh sumber lain berikut:

\begin{enumerate}[label=\alph*), leftmargin=*]
  \item Artikel Jurnal --- \cite{mellers2000choice}
  \item Buku --- \cite{gerhardt2004love}
  \item Database Online --- \cite{borman1993role}
  \item Situs web --- \cite{fredrickson2000cultivating}
\end{enumerate}

Daftar pustaka akan tersusun otomatis dalam gaya APA pada bagian akhir
buku.
...
\noindent\textbf{H}\medskip

\noindent\textbf{I}\medskip
...
\noindent\textbf{J}\medskip

\noindent\textbf{K}\medskip

\noindent\textbf{L}\medskip
